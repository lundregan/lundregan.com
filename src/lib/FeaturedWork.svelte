	...
	<div class="mt-4 flex flex-col gap-6">
		{#each works as work}
			<div class="flex">
				...
				<div class="flex w-full flex-col gap-1 rounded-r-xl bg-zinc-900 p-8">
					<span class="text-gray-400">{work.client}</span>
					<h3 class="text-2xl text-blue-500">{work.title}</h3>
